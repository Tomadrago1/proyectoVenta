...
INSERT INTO productos (id_categoria, nombre_producto, precio_compra, precio_venta, codigo_barras, stock)
VALUES
  -- Categoría: Alimentos
  ...
  (2, 'Jugo de Naranja 1L', 1416.00, 2124.00, '7', 150),
  
  -- Categoría: Limpieza
  (3, 'Detergente 1L', 1770.00, 2655.00, '8', 200),
  (3, 'Jabón en Barra 200g', 472.00, 708.00, '9', 250),
  (3, 'Desinfectante 1L', 1416.00, 2124.00, '10', 180),

  -- Categoría: Snacks
  (4, 'Galletitas 400g', 1180.00, 1770.00, '11', 200),
  (4, 'Chocolinas 300g', 1416.00, 2124.00, '12', 150),
  (4, 'Papa Frita 200g', 1180.00, 1770.00, '13', 300),
  
  -- Categoría: Productos Frescos
  (5, 'Lechuga (unidad)', 590.00, 885.00, '14', 100),
  (5, 'Tomate (kg)', 1770.00, 2655.00, '15', 120),
  (5, 'Pechuga de Pollo (kg)', 4130.00, 6195.00, '16', 90),
